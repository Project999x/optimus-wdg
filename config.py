...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7635155537:AAH2k19PRluAsjYxTjbkbUhNPmKzUWKMgtk")
...
DB_NAME = os.environ.get("DATABASE_NAME", "Optimus_Core_bot")
#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002318495151"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002203266394"))

TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "4"))

START_PIC = os.environ.get("START_PIC", "https://envs.sh/L6d.jpg")
FORCE_PIC = os.environ.get("FORCE_PIC", "https://envs.sh/L62.jpg")
